...
Quindi $B_1\subseteq\acl D$ e $|D|<|B_2|$ (in quanto unione di cardinalit\`a $|B_2|$ di insiemi finiti). Per la transitivit\`a della chiusura algebrica, $C\subseteq\acl D$ e questo contraddice l'indipendenza di $B_2$ perch\'e $B_2\sm D$ \`e non vuoto. Anche questo argomento si generalizza immediatamente come richiesto in \ssf{3}. 
